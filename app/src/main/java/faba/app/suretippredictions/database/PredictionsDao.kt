...
interface PredictionsDao {
    ...
    @Transaction
    @Query("SELECT id,date, status, goals, score, predictions,homeName,homeLogo,awayName,awayLogo,odds,league,predictionString FROM predictions_table WHERE date = :date")
