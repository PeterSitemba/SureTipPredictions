...
@HiltViewModel
class PredictionsViewModel @Inject constructor(private val predictionsRepository: PredictionsRepository) : ViewModel(){

    val errorMessage = MutableLiveData<String>()
    val loading = MutableLiveData<Boolean>()
    val matchEventsList = MutableLiveData<List<Events>>()
    val roomMatchEventsList: LiveData<MatchEvents> = predictionsRepository.roomMatchEventsList.asLiveData()
    var job : Job? = null
